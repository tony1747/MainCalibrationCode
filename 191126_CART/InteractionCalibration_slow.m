...
figure;hold on;
plot(plottime-plottime(1),modFit(:,1)+modFit(:,3),'--r','LineWidth',1)
%plot(plottime,modFit(:,2)+modFit(:,3),'-b','LineWidth',1)
%plot(plottime,modFit(:,3),'
plot(fitData.xdata-fitData.xdata(1),fitData.ydata(:,1),'ok','MarkerSize',6,'MarkerFaceColor','k')
legend({'Cancer','data'})
...
%plot(plottime-plottime(1),modFit(:,2)+modFit(:,3),'-b','LineWidth',1)
%plot(plottime,modFit(:,3),'
